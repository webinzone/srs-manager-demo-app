...
<div id="webui">
    ...
    <div class="row">
        ...
        <div class=" col" style="padding-left: 100px;">
          ...
          <form id="create-form" class="form-horizontal" method="post" action="{{ route('staff_roasters.store') }}"  style="width: 1050px; align-items: center;   background-color: #fff; " autocomplete="off" role="form" >
                 {{ csrf_field() }}
      ...
      <div class="box-body">
                              ...
                              <table >
                                <thead>
                                  <tr>
                                    ...
                                    <td colspan="4" style="">Date&nbsp;&nbsp;<input type="date" name="s_date" value="Date">
                                    </td>
                                  </tr>
                                  <tr>
            ...
            <table style="border-color: white;">
                <td><input type="text" name="con_1" id="con_1" class="form-control" placeholder="Staff"></td>
                <td><input type="text" name="con_2" id="con_2" class="form-control" placeholder="Init"></td>
                <td><input type="text" name="con_3" id="con_3" class="form-control" placeholder="Task">    </td>
            </table>
