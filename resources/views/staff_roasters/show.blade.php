    ...
    <div class="row">
      ...
      <div class="box-body">
                              ...
                              <table >
                                <thead>
                                  <tr>
                                    ...
                                    <td colspan="4" style="">Date&nbsp;&nbsp;<input type="date" name="s_date" value="{{ $staff_roaster->s_date}}" readonly>
                                    </td>
                                  </tr>
                                  <tr>
                                ...
                                <tbody>
                                    ...
                                    <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->position[$i]}} name="position"  type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->pr_time[$i]}} name="pr_time" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->mon[$i]}} name="mon" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->tues[$i]}} type="text" readonly name="tues"  >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->wed[$i]}} name="wed" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->thurs[$i]}} name="thurs" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->fri[$i]}} name="fri" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->sat[$i]}} name="sat" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->sun[$i]}} name="sun" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->s_name[$i]}} name="s_name" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->init[$i]}} name="init" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->task[$i]}} name="task" type="text" readonly >
                                     </td>
                                     <td class="row-index text-center">
                                     <input value="{{ $staff_roaster->total_hrs[$i]}} name="total_hrs" type="text" readonly >
                                     </td>
            ...
            <table style="border-color: white;">
                <td><input type="text" readonly value="{{ $staff_roaster->con_1}}" name="con_1" id="con_1" class="form-control" placeholder="Staff"></td>
                <td><input type="text" readonly value="{{ $staff_roaster->con_2}}" name="con_2" id="con_2" class="form-control" placeholder="Init"></td>
                <td><input type="text" readonly value="{{ $staff_roaster->con_3}}" name="con_3" id="con_3" class="form-control" placeholder="Task">    </td>
            </table>
