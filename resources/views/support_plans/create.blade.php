...
<div id="webui">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-0">
          ...
          <form id="create-form" class="form-horizontal" method="post" action="{{ route('support_plans.store') }}" autocomplete="off" role="form" style="width: 800px;">
                 {{ csrf_field() }}
                ...
                <div class="box-body" style="padding-left: 40px;padding-right: 40px;">                          
                    <div class="form-group ">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <textarea  name="hygiene" class="form-control" placeholder="Personal Hygiene"></textarea>                
                      </div>
                  </div>
                  <div class="form-group ">
                      <div class="col-md-6 mb-3">
                        <label for="name">Nutrition</label>
                        <textarea  name="nutrition" class="form-control" placeholder="Eating ana Nutrition"></textarea>                
                      </div>
                         <div class="col-md-6 mb-3">
                        <label for="name">Health Care</label>
                        <textarea  name="health_care" class="form-control" placeholder="Health Care"></textarea>                
                      </div>                       
                    </div>
                    <div class="form-group ">
                        <div class="col-md-6 mb-3">
                        <label for="name">Medication details</label>
                        <textarea  name="medication" class="form-control" placeholder="Medication Details"></textarea>                
                      </div>
                      <div class="col-md-6 mb-3">
                        <label for="name">Social Contact and Emotional Wellbeing</label>
                        <textarea  name="social_contact" class="form-control" placeholder="Social Contact and Emotional Wellbeing"></textarea>                
                      </div> 
                    </div>
                    <div class="form-group ">
                        <div class="col-md-6 mb-3">
                        <label for="name">Behaviour</label>
                        <textarea  name="behaviour" class="form-control" placeholder="Behaviour"></textarea>                
                      </div>
                      <div class="col-md-6 mb-3">
                        <label for="name">Goals/Finances/Other</label>
                        <textarea  name="goals" class="form-control" placeholder="Goals/Finances/Other"></textarea>                
                      </div>   
                    </div>
                  <!--  <div class="form-group ">
