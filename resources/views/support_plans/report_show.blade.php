      ...
      <div class="col-md-7">
           ...
           <div class="box box-default" style="left: 100px;padding-bottom: 50px;">
              <!-- box-header -->
                 ...
                 <h3><b>Personel care Support Plan</b></h3>
           ...
           <form class="form-horizontal" target="_blank"  action="{{ route('generatePlansReport') }}" method="get" >

                     <div class="form-row">
                      <div class="col-md-5 mb-3">
                        <label for="fname">Select Resident Name</label>
                         <select id="selectID" class="form-control" required=""  name="res" style="height: 26px;padding: 3px 10px;">
                            <option>--   Select Resident Name  --</option>

                          @foreach($support_plan as $resident)
