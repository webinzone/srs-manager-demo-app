                      ...
                      <div class="col-md-3 mb-3">
                        <label for="cgender">Gender</label>&nbsp;&nbsp;&nbsp;
                          <select name="cgender" id="cgender" class="form-control" style="height: 26px;padding: 3px 10px;width: 200px;"> 
                            ...
                            <option value="Male" {{ $referral->cgender == 'Male' ? 'selected' : ''  }} style="font-size: 14px;">Male</option> 
                            <option value="Female" {{ $referral->cgender == 'Female' ? 'selected' : ''  }} style="font-size: 14px;">Female</option> 
                        </select>
               ...
               <div class="form-row">
                ...
                <div class="form-row">
                      ...
                      <div class="col-md-3 mb-3">
                        ...
                        <input type="date" name="pen_mediexp" id="mediexp" class="form-control" value="{{ $referral->pen_mediexp}}" placeholder="Expiry Date" >                                        
                      </div>
