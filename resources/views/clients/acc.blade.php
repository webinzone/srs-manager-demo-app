...
<div id="webui">  
  <div class="row" style="padding-left: 80px;padding-right: 80px;">
        ...
        <div class="col-md-10 offset-1">
          <form class="form-horizontal" method="POST" action="{{ route('clients.store') }}" autocomplete="off" role="form" style="width: 1000px; align-items: center;   background-color: #fff; " enctype="multipart/form-data" novalidate>
              {{ csrf_field() }}
                ...
                <div class="page" v-show="step === 1">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="tel" class="form-control" id="ph" placeholder="Phone number" name="ph" v-on:change="page_one.ph = $event.target.value" required
    ...
    var fname = $("#fname").val();
      ...
      $.ajax({
        ...
        data: { "fname": fname,
                ...
                "medicard_orderno": medicard_orderno,
