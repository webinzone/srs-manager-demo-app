                  ...
                  <div class="page" v-show="step === 1">
                    ...
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="text" value="{{ $client_detail->address}}" class="form-control" id="address" placeholder="Address" name="address" required v-on:change="page_one.address = $event.target.value">          
                      </div>
                      <div class="col-md-4 mb-3">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="text" value="{{ $client_detail->cob}}" class="form-control" id="cob" placeholder="Country of birth" name="cob" required v-on:change="page_one.cob = $event.target.value">          
                      </div>  
                    </div>&nbsp;&nbsp;&nbsp;
                    <div class="form-row">
                      <div class="col-md-2 mb-3">
                        <label for="age">Age</label>
                        <input type="number" value="{{ $client_detail->age}}" class="form-control" id="age" placeholder="age" name="age" required v-on:change="page_one.age = $event.target.value">              
                      </div>  
                      <div class="col-md-2 mb-3">
                    ...
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="tel" value="{{ $client_detail->ph}}" class="form-control" id="ph" placeholder="000-000-0000" name="ph" v-on:change="page_one.ph = $event.target.value">              
                      </div> 
                      <div class="col-md-4 mb-3">
                        <label for="medicard_no">Medicare card number</label>
                        <input type="text" value="{{ $client_detail->medicard_no}}" class="form-control" id="medicard_no" placeholder="Languages Known" name="medicard_no" required v-on:change="page_one.medicard_no = $event.target.value">          
                      </div> 
                      <div class="col-md-4 mb-3">
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="text" value="{{ $client_detail->pension_no}}" class="form-control" id="pension_no" placeholder="Pension card number" name="pension_no" required v-on:change="page_one.pension_no = $event.target.value">          
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="insurance_no">Insurance card number if any</label>
                        <input type="text" value="{{ $client_detail->insurance_no}}" class="form-control" id="insurance_no" placeholder="Insurance card number if any" name="insurance_no" required v-on:change="page_one.insurance_no = $event.target.value">            
                      </div>  
                       <div class="col-md-4 mb-3">
                        <label for="insu_compny">Insurance company name</label>
                        <input type="text" value="{{ $client_detail->insu_compny}}" class="form-control" id="insu_compny" placeholder="Insurance company name" name="insu_compny" required v-on:change="page_one.insu_compny = $event.target.value">          
                      </div>
                    </div>&nbsp;&nbsp;&nbsp;
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="text" value="{{ $client_detail->reference_source}}" class="form-control" id="Reference Source" placeholder="reference_source" name="reference_source" v-on:change="page_one.reference_source = $event.target.value">            
                      </div> 
                      <div class="col-md-4 mb-3">
                        <label for="funding_source">Funding source</label>
                        <input type="text" value="{{ $client_detail->funding_source}}" class="form-control" id="funding_source" placeholder="Funding source"  name="funding_source" required v-on:change="page_one.funding_source = $event.target.value">                
                      </div>
                      
                      <div class="col-md-4 mb-3">
                        <label for="allowed_status">Visitors Allowed ?</label>
                        <br><input type="radio" {{ $visitor->allowed_status == "Yes" ? 'checked' : '' }} id="allowed_status"  value="Yes" name="allowed_status" required v-on:change="page_one.allowed_status = $event.target.value">&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;
                        <input type="radio" {{ $visitor->allowed_status == "No" ? 'checked' : '' }} id="allowed_status" value="No" name="allowed_status" required v-on:change="page_one.allowed_status = $event.target.value">&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <textarea class="form-control" id="tof_allergy" placeholder=" Hobbies" name="tof_allergy" v-on:change="page_one.tof_allergy = $event.target.value">{{$allergy->tof_allergy}}</textarea>     
                      </div> 
                      <div class="col-md-4 mb-3">
                        <label for="hobies"> Hobbies</label>
                        <textarea class="form-control" id="hobies" placeholder=" Hobbies" name="hobies" required v-on:change="page_one.hobies = $event.target.value">{{$client_detail->hobies}}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="text" value="{{ $next_of_kin->name}}" class="form-control" id="nok_name" placeholder="Name" name="nok_name" v-on:change="page_one.nok_name = $event.target.value">              
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="nok_address">Address</label>
                        <input type="text" value="{{ $next_of_kin->address}}" class="form-control" id="nok_address" placeholder="Address" name="nok_address" v-on:change="page_one.nok_address = $event.target.value">              
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="nok_ph">Phone Number</label>
                        <input type="tel" value="{{ $next_of_kin->ph}}" class="form-control" id="nok_ph" placeholder="Phone Number" name="nok_ph" v-on:change="page_one.nok_ph = $event.target.value">  
                      </div>  
                    </div>&nbsp;&nbsp;&nbsp;
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-3">
                          ...
                          <input type="tel" value="{{ $gpdetail->ph}}" class="form-control" id="ph3" placeholder="000-000-0000" name="ph3" v-on:change="page_one.ph3 = $event.target.value">              
                        </div>  
                    </div>&nbsp;&nbsp;&nbsp;
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
