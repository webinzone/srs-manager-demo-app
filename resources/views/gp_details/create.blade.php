...
<div id="webui">
	...
	<div class="row">
	    ...
	    <div class=" col" style="padding-left: 100px;">
	      ...
	      <form id="create-form" class="form-horizontal" method="post" action="{{ route('gp_details.store') }}"  style="width: 1100px; align-items: center;   background-color: #fff; " autocomplete="off" role="form" >
                 {{ csrf_field() }}
	            ...
	            <div class="box-body" style="padding-left: 50px;padding-right: 0px;">		                    
					...
					<div class="col-md-4 mb-3">
                      ...
                      <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="room" id="room" placeholder="Room No" class="form-control" readonly>					        	        
					   </div>
					       <div class="col-md-2 mb-3">
					    <label for="name" >Bed</label>
  	                     
                        <input type="text" name="bed" id="bed" placeholder="Bed No" class="form-control" readonly>
					  </div>
                            <div class="col-md-3 mb-3">
                              <label for="name" >Date of Birth</label>
                                         
                                <input type="text" name="dob" id="dob" placeholder="Date of Birth" class="form-control" readonly>
                            </div>
				    </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
