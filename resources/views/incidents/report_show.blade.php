      ...
      <div class="col-md-7">
           ...
           <div class="box box-default" style="left: 100px;padding-bottom: 50px;">
              <!-- box-header -->
                 ...
                 <h3><b>Generate Incident Report</b></h3>
           ...
           <form class="form-horizontal" target="_blank"  action="{{ route('generateIncidentReport') }}" method="get" >
                      ...
                      <div class="col-md-5 mb-3">
                        <label for="fname">Select Resident Name</label>
                         <select class="form-control" required="" id="res_name" name="res_name" style="height: 26px;padding: 3px 10px;">
                          ...
                          @foreach($incidents as $resident)
                          <option value="{{ $resident->client_id }}"> {{ $resident->p_name}}</option>
                          @endforeach
                        </select>
