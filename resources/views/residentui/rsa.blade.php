...
<div id="webui">  
  <div class="row" style="padding-left: 30px;padding-right: 80px;">
        ...
        <div class="col-md-10 offset-1">
         ...
         <form id="create-form" class="form-horizontal" method="post" action = "{{ route ('resident_agreements.update', [$resident_agreement->id, 'val' => 'res']) }}" style="width: 1000px; align-items: center;   background-color: #fff; " autocomplete="off" role="form" >
            @method('PATCH') 
            ...
            <!-- box -->
              <div class="box box-default">
                ...
                <div class="box-header with-border text-center">
                       <h3><b>Resident Agreement - {{ $resident_agreement->r_name }}</b></h3>
