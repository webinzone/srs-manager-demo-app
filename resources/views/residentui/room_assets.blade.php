 ...
 <div class="panel with-nav-tabs panel-default" style="padding-left:28px;padding-right: 32px;background-color: #BDF5BD;border-color: #BDF5BD;">
  ...
  <div class="row" style="padding-left: 30px;padding-right: 80px;">
        ...
        <div class="col-md-10 offset-1">
         ...
         <form id="create-form" class="form-horizontal" method="post" action = "{{ route ('condition_reports.update', [$condition_report->id, 'val' => 'res']) }}" style="width: 1000px; align-items: center;   background-color: #fff; " autocomplete="off" role="form" >
            @method('PATCH') 
            ...
            <!-- box -->
             <div class="box box-default">
              ...
              <div class="box-header with-border text-center">
                 <h3><b>Condition Report - {{ $condition_report->res_name }}</b></h3>
