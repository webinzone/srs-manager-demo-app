...
<div id="webui">  
  <div class="row" style="padding-left: 30px;padding-right: 80px;">
        ...
        <div class="col-md-10 offset-1">
          ...
          <form id="create-form" class="form-horizontal" method="post" action="{{ route('transfer_records.update', [$transfer_record->id, 'val' => 'res']) }}" style="width: 1000px; align-items: center;   background-color: #fff; " autocomplete="off" role="form" >
             @method('PATCH') 
                 {{ csrf_field() }}
