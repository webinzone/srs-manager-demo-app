 ...
 <div id="webui">
    <div class="row" >
      ...
      <div class="col-md-7">
           ...
           <form class="form-horizontal" target="_blank"  action="{{ route('generateRSAReport') }}" method="get" >
                      ...
                      <div class="col-md-5 mb-3">
                        <label for="fname">Select Resident Name</label>
                         <select class="form-control" required="" id="res_name" name="res_name" style="height: 26px;padding: 3px 10px;">
                          ...
                          @foreach($agreements as $resident)
                          <option value="{{ $resident->client_id }}"> {{ $resident->r_name}}</option>
                          @endforeach
                        </select>
