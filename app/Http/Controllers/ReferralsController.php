...
class ReferralsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('referrals/show',compact('referral','referral2','drug','dose','freq','duration','last','num'));
    }
     /**
    ...
    public function generateReferralReport(){
      ...
      return view('referrals/report',compact('referral','referral2','drug','dose','freq','duration','last','num'));
    }
