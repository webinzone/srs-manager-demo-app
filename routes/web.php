...
Route::group(['middleware' => 'auth'], function () {
   ...
   //Client Details
    ...
    Route::get('/generateAccountReport/', 'ClientsController@generateAccountReport')->name('generateAccountReport');
     ...
     Route::get('/generateHandoverfullReport/', 'HandoversController@generateHandoverfullReport')->name('generateHandoverfullReport');
    ...
    Route::get('get/firstlname/{id}', 'ConditionReportsController@getLname')->name('getLname');
